...
train_dir = 'C:\\Users\\MY DELL\\PycharmProjects\\video_monitoring\\my_app\\data\\train'
val_dir = 'C:\\Users\\MY DELL\\PycharmProjects\\video_monitoring\\my_app\\data\\test'
...
if mode == "train":
    ...
    model.save_weights(r'C:\Users\MY DELL\PycharmProjects\video_monitoring\my_app\model.h5')

# emotions will be displayed on your face from the webcam feed
# elif mode == "display":
#     model.load_weights(r'D:\backups\Emotion-detection-master\model.h5')
#
...
#         if not ret:
#             break
#         facecasc = cv2.CascadeClassifier(r'D:\backups\Emotion-detection-master\src\haarcascade_frontalface_default.xml')
